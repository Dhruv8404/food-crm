      ...
      >
        ...
        <AnimatePresence mode="wait">
          {state.cart.length === 0 ? (
            ...
            >
              <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-purple-50/50 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-12 text-center">
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.2, type: "spring" }}
                    className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-purple-100"
                  >
                  ...
                  <p className="mb-8 text-lg text-muted-foreground max-w-md mx-auto">
                    Looks like you haven't added any delicious items to your cart yet. Let's fix that!
                  </p>
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-2 bg-white rounded-full p-1 shadow-inner border">
                                <Button
                                  ...
                                  className="h-8 w-8 rounded-full p-0 hover:bg-red-50 hover:text-red-600 transition-colors"
                                >
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  onClick={() => updateQty(item.id, item.qty + 1)}
                                  className="h-8 w-8 rounded-full p-0 hover:bg-green-50 hover:text-green-600 transition-colors"
                                >
                  ...
                  <CardContent className="p-6">
                    ...
                    >
                      <Button
                        onClick={() => {
                          if (!state.currentTable) {
                            // No table selected, redirect to scan page
                            navigate('/')
                          } else {
                            handleCheckout()
                          }
                      ...
                      <Button
                        onClick={() => navigate("/menu")}
                        variant="outline"
                        className="w-full rounded-xl border-2 border-purple-200 text-purple-600 hover:bg-purple-50 hover:text-purple-700 py-6 text-lg font-semibold"
                        size="lg"
                      >
                        <ChefHat className="w-5 h-5 mr-2" />
                        Add More Items
